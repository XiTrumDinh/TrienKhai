...
-- Thời gian đã tạo: Th3 29, 2026 lúc 08:45 PM
...
CREATE TABLE IF NOT EXISTS `product_specs` (
  ...
  `spec_name` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `spec_value` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
